...
public class BicubicSolid extends Solid {
    ...
    public BicubicSolid(Boolean filled) {
        ...
        if (!filled) {
            ...
            elementBuffer.add(new Element(TopologyType.LINE, 0, (ACCURACY * (ACCURACY - 1) * 4)));
        }
        ...
        if (filled) {
            ...
            elementBuffer.add(new Element(TopologyType.TRIANGLE, 0, ((ACCURACY - 1) * (ACCURACY - 1) * 6)));
        }
